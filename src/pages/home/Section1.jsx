        ...
        >
            ...
            >
                ...
                <div className="flex md:mt-10 mt-5 justify-center space-x-4">
                    <Link
                        href="/competitions"
                        className="px-12 py-2 flex items-center justify-center rounded-lg text-white font-semibold bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 animate-pulse shadow-lg shadow-pink-500/50 hover:shadow-purple-500/70 transition"
                    >
                        Register Now
                    </Link>
